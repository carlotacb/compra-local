...
class APIReviewDoneTest(unittest.TestCase):

    def setUp(self):
        self.url = f'http://localhost:{PYTHON_MODULE_PORT}/review/done'
        self.user_id = 1
    ...
    def test_done(self):
        ...
        self.assertIsNotNone(response.get('response').get('done_reviews'))
