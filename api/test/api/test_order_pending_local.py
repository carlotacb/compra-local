...
class APIOrderPendingLocalTest(unittest.TestCase):

    def setUp(self):
        self.url = f'http://localhost:{PYTHON_MODULE_PORT}/order/pending/local'
        self.local_id = 1
    ...
    def test_pending(self):
        ...
        self.assertIsNotNone(response.get('response').get('pending_order_list'))
