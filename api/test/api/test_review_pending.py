...
class APIReviewPendingTest(unittest.TestCase):

    def setUp(self):
        self.url = f'http://localhost:{PYTHON_MODULE_PORT}/review/pending'
        self.user_id = 1
    ...
    def test_pending(self):
        ...
        self.assertIsNotNone(response.get('response').get('pending_reviews'))
