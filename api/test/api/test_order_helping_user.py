...
class APIOrderHelpingUserTest(unittest.TestCase):

    def setUp(self):
        self.url = f'http://localhost:{PYTHON_MODULE_PORT}/order/helping/user'
        self.user_id = 2
    ...
    def test_helping(self):
        ...
        self.assertIsNotNone(response.get('response').get('helping_order_list'))
