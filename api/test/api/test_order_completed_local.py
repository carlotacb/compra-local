...
class APIOrderCompletedLocalTest(unittest.TestCase):

    def setUp(self):
        self.url = f'http://localhost:{PYTHON_MODULE_PORT}/order/completed/local'
        self.local_id = 1
    ...
    def test_pending(self):
        ...
        self.assertIsNotNone(response.get('response').get('completed_order_list'))
