    ...
    if count == 0:
        ...
        object_list = [
            Local(
                ...
                pick_up=True, delivery=True, image=image.encode_and_resize('test/mock/local_image_1.jpg'),
            ...
            Local(
                ...
                pick_up=True, delivery=False, image=image.encode_and_resize('test/mock/local_image_2.jpg'),
